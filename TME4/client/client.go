...
func creation_emp() personne_emp {
...
func (p *personne_emp) initialise() {
	p.personne = personne_de_ligne(lecteur())
...
func lecteur() string {
	...
	separation := separateur.Split(string(dat), -1)
	return separation[rand.Intn(len(separation)-1)+1]
}
